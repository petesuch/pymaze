#
#   eightyColumnNewline.py
#
#   roughly breaks a text file that does not contain newlines to roughly
#   80 characters per line.  Useful for breaking up Kindle content so that it
#   is more easily edited with your favorite editor.
#
